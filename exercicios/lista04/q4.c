// Calcula a quantidade de meses completos a partir de um valor dado em dias. Se a quantidade de dias fornecidos não for suficiente para formar um mês completo o código exibe uma mensagem de erro.
